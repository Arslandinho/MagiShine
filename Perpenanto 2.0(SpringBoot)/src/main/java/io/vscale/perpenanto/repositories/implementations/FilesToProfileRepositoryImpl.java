...
import io.vscale.perpenanto.dto.implementations.FilesToProfileDTO;
...
public class FilesToProfileRepositoryImpl implements FilesToProfileRepository{
    ...
    @Autowired
    public FilesToProfileRepositoryImpl(JdbcTemplate template, JdbcTemplateWrapper<FilesToProfile> jdbcTemplateWrapper){
    ...
    public void update(FilesToProfile model) {
        ...
        Optional<FilesToProfile> tempFilesToProfile =
                this.jdbcTemplateWrapper.findItem(FilesToProfileRepositoryImpl.this, model.getProfile().getId());
        ...
        tempFilesToProfile.ifPresent(filesToProfile ->{
            ...
            model.getFiles()
                 .stream()
                 .filter(file -> !filesToProfile.getFiles().contains(file))
                 .forEach(filesToProfile.getFiles()::add);
